...
'''
if you already have a instance , specify it and
ECSInstanceContext will use the instance othersize
will create one.
...
If you specify need_public_ip to true(which is False by default), 
we will allocate a public ip for your instance, and will use the public ip to connect.
'''
...
try:
    ...
    still not ready, you can use  is_ssh_server_ready to check if the ssh server ready.
